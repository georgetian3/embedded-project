...
\begin{itemize}
    ...
    \code[fontsize=\small]{./audioplayer-xc: /lib/libc.so.6: version `GLIBC_2.34' not found (required by ./audioplayer-xc)}
...
为开发板的 ARM 处理器进行交叉编译需要 Ubuntu 的 \code{gcc-arm-linux-gnueabihf} 包：